...
export const contactConfig = {
  company: {
    name: process.env.NEXT_PUBLIC_COMPANY_NAME || "UptoraElectronics",
    email: process.env.NEXT_PUBLIC_COMPANY_EMAIL || "support@uptoraelectronics.com",
    phone: process.env.NEXT_PUBLIC_COMPANY_PHONE || "+234 (906) 654-1057",
    address:
  ...
  emails: {
    support: process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@uptoraelectronics.com",
    sales: process.env.NEXT_PUBLIC_SALES_EMAIL || "sales@uptoraelectronics.com",
  },
  responseTime: {
    standard:
